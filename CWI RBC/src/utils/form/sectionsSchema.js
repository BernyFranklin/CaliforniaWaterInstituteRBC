...
export const sections = {
  basinSizeAndDesign: {
    ...
    fields: [
      { text: 'Acres of Pond Surface Area', id: 'ac_pond', type: 'number', min: 0, placeholder: '160', infoText: 'This value is automatically set based on your selected area of interest. You can modify it if you have site-specific data.' },
      { text: 'Length of Pond (ft)', id: 'length_pond', type: 'number', min: 0, placeholder: '2640', infoText: 'This value is automatically set based on your selected area of interest. You can modify it if you have site-specific data.' },
      { text: 'Width of Pond (ft)', id: 'width_pond', type: 'number', min: 0, placeholder: '2640', infoText: 'This value is automatically set based on your selected area of interest. You can modify it if you have site-specific data.' },
      ...
      { text: 'Infiltration Rate (ft/day)', id: 'infiltration_rate', type: 'number', min: 0, step: 0.1, placeholder: '0.6', infoText: 'This value is automatically set based on your selected soil type. You can modify it if you have site-specific data.' },
    ],
  },
  waterAvailability: {
  ...
  developmentCosts: {
    ...
    fields: [
      ...
      { text: 'Total ft of Pipeline', id: 'pipeline_length', type: 'number', min: 0, placeholder: '2640', infoText: 'This value is automatically set based on your selected area of interest. You can modify it if you have site-specific data.' },
